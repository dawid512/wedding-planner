...
import { Field as Field2, Check as Check2, Icon as Icon2, outfitTotals } from "./core";
...
// TABLES
// ============================================================
function PageTables({ data, set, editing }: PageProps) {
  ...
  const availableForSeat = (currentId: string) =>
    namedGuests.filter(g => !assignedIds.has(g.id) || g.id === currentId);
...
// VENDORS
// ============================================================
function PageVendors({ data, set, editing }: PageProps) {
...
// SCHEDULE
// ============================================================
function PageSchedule({ data, set, editing }: PageProps) {
  const add = () => set((d: AppData) => ({
    ...d,
...
function PageMenu({ data, set, editing }: PageProps) {
...
function PageOutfits({ data, set, editing }: PageProps) {
...
// INSPIRATION
// ============================================================
function PageInspiration({ data, set, editing }: PageProps) {
  const add = () => set((d: AppData) => ({
    ...d,
...
// GIFTS
// ============================================================
function PageGifts({ data, set, editing }: PageProps) {
  const add = () => set((d: AppData) => ({
    ...d,
...
function PageHoneymoon({ data, set, editing }: PageProps) {
